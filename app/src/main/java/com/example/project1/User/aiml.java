...
public class aiml extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.recycler_view_aiml);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("aiml");
