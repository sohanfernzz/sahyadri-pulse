...
public class dse_ise extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dse_ise, container, false);

        recyclerView = view.findViewById(R.id.recycler_view_dse_ise);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("isds");
